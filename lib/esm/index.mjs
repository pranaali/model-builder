...
export const addField = (modelId, field) => {
    const formatField = {
        ...field,
...
export const updateField = (modelId, field, options) => {
    const formatField = {
        ...field,
        name: _.camelCase(field.title),
        model: modelId,
...
export const removeFieldById = (fieldId) => {
    return DynamicModelField.findByIdAndRemove(fieldId);
};
export const removeField = (modelId, name) => {
    return DynamicModelField.findOneAndRemove({ model: modelId, name });
};
export const saveFields = (modelId, fields) => {
...
export const getModelFields = async (name) => {
...
export const getDynamicModel = async (name, fields, options) => {
    ...
    return model(_.capitalize(name), new Schema(fieldSchemaFormatted, { timestamps: true, ...options }));
};
export const connectToMongoDB = (connectionString) => {
